<nav x-data="{ open: false}" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <div class="shrink-0 flex items-center" style="width: 40%;">
                    <a style="width: 100%;" href="{{ route('dashboard') }}">
                ...
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-dropdown2 align="left" width="48">
                        <x-slot name="trigger">
                            <x-nav-link2 class="pointer" :active="request()->routeIs('employee.*')">
                                {{ __('Employees') }}
                            </x-nav-link2>
                        </x-slot>
            ...
            <div class="mt-3 pb-1 border-t border-b border-gray-200">
                ...
                <div class="mt-3 space-y-1">
                    <div x-data="{model: false }" @click.outside="model = false" @close.stop="model = false">
                        ...
                        <x-mobile-dropdown>
                            <x-mobile-nav-link :href="route('employee.create')">
                                {{__('Create')}}
                            </x-mobile-nav-link>

                            <x-mobile-nav-link :href="route('employee.index')">
                                {{__('List')}}
                            </x-mobile-nav-link>
                        </x-mobile-dropdown>
                    </div>
